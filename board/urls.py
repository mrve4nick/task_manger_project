...
urlpatterns = [
    ...
    path("board/task-type/", TaskTypeListCreateView.as_view(), name="task-type-list-create"),
    path("board/task-type/<int:pk>/", TaskTypeDetailView.as_view(), name="task-type-detail"),
]
